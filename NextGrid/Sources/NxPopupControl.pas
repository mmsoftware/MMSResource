...
function TNxDatePopup.GetDayInWeekChar(DayInWeek: Integer): WideChar; //dmajkic: Char -> WideChar
begin
  Result := ' ';
  ...
  case GetActualStartDay of
    dwSunday: Result := WideChar(LongDayNames[DayInWeek][1]);              // dmajkic: Char -> WideChar
    dwMonday: if DayInWeek = 7 then Result := WideChar(LongDayNames[1][1]) // dmajkic: Char -> WideChar
      else Result := WideChar(LongDayNames[DayInWeek + 1][1]);             // dmajkic: Char -> WideChar
  end;
end;
